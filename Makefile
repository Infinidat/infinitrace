...
#Uncomment to enable some experimental features
#CPPFLAGS+=-DTRACE_USE_MODULAR_RENDERING

CFLAGS=-std=gnu99
CXXFLAGS=-fno-rtti
LIBTRACE_OBJS=trace_metadata_util.o trace_parser.o halt.o hashmap.o validator.o
LIBPARSER_OBJS=timeformat.o parser.o renderer.o trace_node.o out_fd.o filter.o parser_mmap.o hashmap.o trace_metadata_util.o
