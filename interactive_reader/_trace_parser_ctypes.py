...
class operation_progress_status_s(Structure):
    pass
operation_progress_status_s._fields_ = [
    ('records_processed', c_longlong),
    ('current_offset', c_longlong),
]
...
TRACE_MATCHER_CONST_SUBSTRING = 16
...
trace_parser._fields_ = [
    ...
    ('indent', c_int),
    ('relative_ts', c_int),
    ('wait_for_input', bool_t),
    ('inotify_fd', c_int),
    ('inotify_descriptor', c_int),
    ('show_field_names', c_int),
    ('cancel_ongoing_operation', bool_t),
...
__all__ = ['TRACE_TYPE_ID_ENUM', 'N11__mbstate_t4DOT_26E',
           ...
           '_IO_marker', 'N14pthread_cond_t3DOT_6E', '__fsid_t',
           'FILE', '__off64_t', 'size_t', 'trace_file_info',
           'TRACE_MATCHER_TYPE',
           'TRACE_PARSER_UNKNOWN_RECORD_ENCOUNTERED', 'fd_set',
           'trace_parser', 'N4DOT_234DOT_24E',
           'RecordsAccumulatorList_s', 'tm', '__ino64_t',
           ...
           'F_OWNER_PGRP', 'TRACE_MATCHER_CONST_SUBSTRING',
           'trace_record_buffer_dump', 'trace_input_stream_type',
           'TRACE_MATCHER_NOT', '__time_t', 'buffer_dump_context_s',
           '_G_fpos64_t', 'trace_record_metadata',
           'BufferParseContextList', 'trace_enum_value', '_IO_jump_t',
           '__nlink_t', 'TRACE_INPUT_STREAM_TYPE_SEEKABLE_FILE',
           'TRACE_MATCHER_PROCESS_NAME', '__io_close_fn',
           '__va_list_tag', 'sigevent', '__fd_mask',
           ...
           'TRACE_LOG_DESCRIPTOR_KIND_FUNC_LEAVE',
           'operation_progress_status_s', 'timespec',
           ...
           '__blksize_t', 'TRACE_PARSER_OPERATION_IN_PROGRESS',
           ...
           'trace_record_matcher_data_u', 'timeval',
           'RecordsAccumulatorList',
           ...
           'itimerspec', 'bool_t', 'trace_record_accumulator',
